    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "stock_name",
                    models.CharField(
                        help_text="The name of the stock.", max_length=100
                    ),
                ),
                (
                    "is_investable",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "account_number",
                    models.CharField(
                        help_text="The brokerage account number.",
                        max_length=20,
                        unique=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.PositiveIntegerField(help_text="The number of shares."),
                ),
                (
                    "price",
                    models.DecimalField(
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text="Detailed message or error log for the trade.",
                    ),
                ),
                (
                    "account",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "quantity",
                    models.PositiveIntegerField(help_text="The number of shares held."),
                ),
                (
                    "average_buy_price",
                    models.DecimalField(
